      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": `${SITE_BRAND} 是一个免费在线的 Markdown 转微信公众号排版工具。它支持 AI 一键优化文章结构，提供 72 套精美排版模板，帮助用户快速生成适合公众号阅读的精美文章。`
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "AI 一键排版功能可以在不修改原文内容的前提下，自动优化标题层级、空行处理、列表格式、引用块以及重点加粗，让文章结构更加清晰易读。"
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "支持。您可以直接将本地图片拖拽或粘贴到编辑器中，预览区会自动处理图片显示。在复制到公众号时，图片也会随之带入。"
          }
        },
        {
          "@type": "Question",
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "完成排版后，只需点击右上角的“一键复制发布”按钮，然后直接在微信公众号后台编辑器中粘贴即可，格式将完美保留。"
          }
        }
      ]
    }
