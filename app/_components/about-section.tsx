    ...
    <section className="bg-(--neo-bg) border-t-[3px] border-(--neo-ink) py-12 px-4 sm:py-20">
      <div className="max-w-[1000px] mx-auto space-y-16">
        ...
        <div className="neo-panel p-8 sm:p-12 space-y-6">
          <div className="grid grid-cols-[32px_1fr] items-center gap-3 mb-2">
            <Info className="size-8 text-(--neo-pink)" />
          ...
          <p className="text-lg sm:text-xl font-bold leading-relaxed text-(--neo-ink)">
            ...
            它通过简洁的 Neo-Brutalism 视觉风格与 AI 智能排版技术，
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 pt-4">
            <div className="grid grid-cols-[24px_1fr] items-center gap-3">
              <CheckCircle2 className="size-6 text-(--neo-green)" />
              <span className="font-bold leading-6">72 套手工精选模板，涵盖多种风格</span>
            </div>
            <div className="grid grid-cols-[24px_1fr] items-center gap-3">
              <CheckCircle2 className="size-6 text-(--neo-green)" />
              <span className="font-bold leading-6">
                AI 智能识别文章结构，自动优化留白与强调
              </span>
            </div>
            <div className="grid grid-cols-[24px_1fr] items-center gap-3">
              <CheckCircle2 className="size-6 text-(--neo-green)" />
              <span className="font-bold leading-6">实时预览与样式微调，所见即所得</span>
            </div>
            <div className="grid grid-cols-[24px_1fr] items-center gap-3">
              <CheckCircle2 className="size-6 text-(--neo-green)" />
              <span className="font-bold leading-6">支持图片粘贴、数学公式与代码高亮</span>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-8">
          <div className="flex items-center gap-3 justify-center mb-4">
            <HelpCircle className="size-8 text-(--neo-cyan)" />
            <h2 className="text-2xl sm:text-4xl font-black uppercase tracking-tight leading-tight text-center">
              常见问题解答 (FAQ)
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="neo-panel p-6 bg-(--neo-surface)">
              ...
              <p className="font-bold text-(--neo-muted)">
                {SITE_BRAND} 是一个免费在线的 Markdown 转微信公众号排版工具。它支持 AI 一键优化文章结构，提供 72 套精美排版模板，帮助用户快速生成适合公众号阅读的精美文章。
              </p>
            </div>
            ...
            <div className="neo-panel p-6 bg-(--neo-surface)">
              ...
              <p className="font-bold text-(--neo-muted)">
                AI 一键排版功能可以在不修改原文内容的前提下，自动优化标题层级、空行处理、列表格式、引用块以及重点加粗，让文章结构更加清晰易读。
              </p>
            </div>
            ...
            <div className="neo-panel p-6 bg-(--neo-surface)">
              ...
              <p className="font-bold text-(--neo-muted)">
                支持。您可以直接将本地图片拖拽或粘贴到编辑器中，预览区会自动处理图片显示。在复制到公众号时，图片也会随之带入。
              </p>
            </div>
            ...
            <div className="neo-panel p-6 bg-(--neo-surface)">
              ...
              <p className="font-bold text-(--neo-muted)">
                完成排版后，只需点击右上角的“一键复制发布”按钮，然后直接在微信公众号后台编辑器中粘贴即可，格式将完美保留。
              </p>
            </div>
          </div>
        </div>
